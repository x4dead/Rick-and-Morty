...
//   ///
//   ///Дата для истории рейтинга в профиле
//   ///
//   static String getDetailedDate(String createdDate, {bool noTime = false}) {
...
//     return "${buffer.toString().replaceFirstMapped('.', (match) => '')} ${noTime == true ? '' : "г в ${date.hour}:$minute"} ";
//   }
...
//   static String getCreatedDate(DateTime createdDate) {
//     final now = DateTime.now();
//     final today = now.day;
//     final yesterday = now.subtract(const Duration(days: 1)).day;
//     final buffer = StringBuffer();
//     if (createdDate.day == today &&
//         createdDate.month == now.month &&
//         createdDate.year == now.year) {
//       buffer.write(navigatorKey.currentContext!.localization.today);
//     } else if (createdDate.day == yesterday &&
//         createdDate.month == now.month &&
//         createdDate.year == now.year) {
//       buffer.write(navigatorKey.currentContext!.localization.yesterday);
//     } else {
...
//           Localizations.localeOf(navigatorKey.currentContext!).languageCode);
//       buffer.write(dateFormat.format(createdDate));
//     }
//     return buffer.toString();
//   }
